...
nonisolated enum L10n {
    ...
    static var paywallWeeklyFreeTip: String { localized("paywall.weeklyFreeTip") }
    ...
    static var sleepMenuStopCurrentMonitoring: String { localized("sleep.menu.stopCurrentMonitoring") }
    ...
    static var sleepNotificationStartedToast: String { localized("sleep.notification.startedToast") }
